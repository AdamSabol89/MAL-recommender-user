...
def get_user_anime_list(user_id, requester=request_passthrough):
    ...
    while has_more_anime:
        ...
        additional_anime = get_user_anime_list_from_json(response.json(), user_id)
        if additional_anime:
...
def get_user_anime_list_from_json(json, user_id):
    ...
    for mal_anime in json:
        ...
        anime.append({
            ...
            'anime_num_episodes': mal_anime['anime_num_episodes'],
            'anime_airing_status': mal_anime['anime_airing_status'],
            'anime_studios': mal_anime['anime_studios'],
            'anime_media_type_string': mal_anime['anime_media_type_string'],
            'anime_mpaa_rating_string': mal_anime['anime_mpaa_rating_string'],
        })
